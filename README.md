...
## v55 の変更点
- 対応通貨を追加：KRW（韓国ウォン）、NOK（ノルウェークローネ）、SEK（スウェーデンクローナ）、CHF（スイスフラン）、TWD（台湾ドル）、HKD（香港ドル）
- 既存の JPY / USD / EUR / CNY / DKK と同様、現地通貨表示・円換算・CSV `__input_currency` 指定に対応
- サイドバーに各通貨の対円レート入力欄を追加
